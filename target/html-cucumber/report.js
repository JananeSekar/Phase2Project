$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/features/AddtoCard.feature");
formatter.feature({
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_have_launched_the_application()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_enter_username_as(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_enter_password_as(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_click_on_Login_button()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_should_land_on_home_page()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "stepDefs.LoginpageStepdef.i_should_get_the_error_message_as(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
